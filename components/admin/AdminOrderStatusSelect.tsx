            ...
            return (
              <li key={opt} role="presentation">
                <button
                  ...
                  className={`flex w-full items-center gap-2 px-3 py-2.5 text-left text-sm outline-none transition hover:bg-slate-50 focus-visible:bg-slate-100 ${
                    selected
                      ? "bg-slate-100 font-semibold text-emerald-950"
