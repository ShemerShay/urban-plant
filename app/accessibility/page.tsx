  ...
  return (
    ...
    >
      <div className="flex-1 space-y-6">
        ...
        <h1 className="text-display font-semibold text-foreground">{t(locale, "a11y.title")}</h1>

        <section className="text-body space-y-4 leading-6 text-slate-700" aria-labelledby="a11y-commitment">
          <h2 id="a11y-commitment" className="text-heading-sm font-semibold text-foreground">
        ...
        <section className="text-body space-y-4 leading-6 text-slate-700" aria-labelledby="a11y-contact">
          <h2 id="a11y-contact" className="text-heading-sm font-semibold text-foreground">
          ...
          <ul className="list-disc space-y-2 ps-5">
            <li>
              ...
              <a
                ...
                className="font-medium text-brand underline-offset-4 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 focus-visible:ring-offset-2"
              >
                {PUBLIC_CONTACT_EMAIL}
              </a>
            </li>
