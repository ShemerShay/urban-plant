...
const API_ERROR_KEYS: Record<string, MessageKey> = {
  ...
  "Could not mark plants as watered": "admin.water.failed",
  "Invalid JSON body": "admin.water.failed",
  "Invalid body": "admin.water.failed",
  "partnerLocationId is required": "admin.water.failed",
  "posSpotIds must be an array": "admin.water.failed",
  "posSpotIds must include at least one id": "admin.water.failed",
  "Partner Location not found": "admin.water.failed",
